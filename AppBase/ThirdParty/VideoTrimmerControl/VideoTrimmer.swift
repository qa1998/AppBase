...
@IBDesignable class VideoTrimmer: UIControl {
	...
	private func setup() {
		...
		leadingGestureRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(Self.leadingGrabberPanned(_:)))
		...
		trailingGestureRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(Self.trailingGrabberPanned(_:)))
		...
		progressGestureRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(Self.progressGrabberPanned(_:)))
		...
		thumbnailInteractionGestureRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(Self.thumbnailPanned(_:)))
